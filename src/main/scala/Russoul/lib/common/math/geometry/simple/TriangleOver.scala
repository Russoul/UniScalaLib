...
/**
  ...
  */
@immutable class TriangleOver[V[_,_], @specialized F](p1:V[F,_3], p2:V[F,_3], p3:V[F,_3])(implicit ev: CanonicalEuclideanSpaceOverField[V,F,_3]) extends Shape3[V[F,_3],F] {
