...
/**
  ...
  */
@immutable class Line2Over[V[_,_ <: Nat], @specialized F : Field]private(val start:V[F,_2], val end:V[F,_2])(implicit ev: CanonicalEuclideanSpaceOverField[V,F,_2])  extends Shape2[V[F,_2],F] {
...
object Line2Over{
  def apply[V[_,_ <: Nat], @specialized F : Field](start:V[F,_2], end:V[F,_2])(implicit ev: CanonicalEuclideanSpaceOverField[V,F,_2]) = new Line2Over[V,F](start, end)
}