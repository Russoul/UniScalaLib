...
/**
  ...
  */
@immutable class Ray2Over[V[_,_ <: Nat], @specialized F : Field]private(val start: V[F,_2],val dir: V[F,_2])(implicit ev: CanonicalEuclideanSpaceOverField[V,F,_2], tensor1:Tensor1[F,V,_2])  extends Shape2[V[F,_2],F] {
...
object Ray2Over{
  def apply[V[_,_ <: Nat], @specialized F : Field](start: V[F,_2], dir: V[F,_2])(implicit ev: CanonicalEuclideanSpaceOverField[V,F,_2], tensor1:Tensor1[F,V,_2]) = new Ray2Over[V,F](start, dir)
}