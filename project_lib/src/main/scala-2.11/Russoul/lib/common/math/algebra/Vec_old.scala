...
case class Vec_old[A <: Dim : NotNothing, @specialized B](dim: A, array:Array[B])(implicit tagA: ClassTag[A], tagB: ClassTag[B], ev: Field[B] with Euclidean[B]){
...
object Vec_old{
  def apply[A <: Dim : NotNothing, B](dim:A, seq: B*)(implicit tagA: ClassTag[A], tagB : ClassTag[B], ev: Field[B]): Vec_old[A,B] = {
  ...
  //EXTRA OPS...........................................................................
  @inline def ⟂[B : Field](v:Vec_old[Two, B]):Vec_old[Two,B] = {
    Vec_old(Two, v.y, -v.x)
  }


  @inline def ⨯[B : Field](a:Vec_old[Three,B], b:Vec_old[Three,B]):Vec_old[Three,B] = {
