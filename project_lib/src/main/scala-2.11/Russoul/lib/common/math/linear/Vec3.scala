...
@immutable case class Vec3[@specialized A](array:Array[A])(implicit ev: Field[A] with Euclidean[A]) {
...
object Vec3 {
  @inline def apply[@specialized A : Field](x: A, y: A, z: A) = new Vec3(x,y,z)
  @inline def apply[@specialized A : Field](v2:Vec2[A], z:A) = new Vec3(v2.x, v2.y, z)
}
